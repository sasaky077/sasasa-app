...
(function () {
  ...
  const MATERIAL_MASTER = Object.freeze({
    ...
    soul_vessel_fire: Object.freeze({
      id: 'soul_vessel_fire',
      name: '魂の器(火)',
      shortName: '魂の器(火)',
    ...
    soul_vessel_aqua: Object.freeze({
      id: 'soul_vessel_aqua',
      name: '魂の器(水)',
      shortName: '魂の器(水)',
    ...
    soul_vessel_wood: Object.freeze({
      id: 'soul_vessel_wood',
      name: '魂の器(木)',
      shortName: '魂の器(木)',
    ...
    soul_vessel_dark: Object.freeze({
      id: 'soul_vessel_dark',
      name: '魂の器(闇)',
      shortName: '魂の器(闇)',
    ...
    soul_vessel_light: Object.freeze({
      id: 'soul_vessel_light',
      name: '魂の器(光)',
      shortName: '魂の器(光)',
