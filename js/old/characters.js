...
const CHARACTERS = [
  ...
  { id: 7, name: 'ミユ', gender: 'woman', rarity: 'r',
    ...
    skills: [
      { id: 's1', name: 'バン',   cdMax: 0, hit: 90,  type: 'attack', multiplier: 1.0, range: 'pierce_all',
        pierce: true,
        effects: [],
        desc: '敵に祈りを込めた弾を打ち込む。中ダメージ。' },

      { id: 's2', name: 'バキューン',   cdMax: 3, hit: 100, type: 'attack', multiplier: 0,   range: 'pierce_all',
        pierce: true,
        effects: [],
        desc: '敵に祈りを込めた弾を乱れ打つ。中ダメージ。' },

      { id: 's3', name: 'ドカーン', cdMax: 3, hit: 85,  type: 'attack', multiplier: 0,   range: 'pierce_all',
        pierce: true,
        effects: [],
  ...
  { id: 8, name: 'カミジョウ', gender: 'man', rarity: 'r',
    ...
    skills: [
      { id: 's1', name: '正突',   cdMax: 0, hit: 90,  type: 'attack', multiplier: 1.0, range: 'pierce_all',
        pierce: false,
        effects: [],
        desc: '杖で敵を攻撃する。敵を1マス後ろに押し出す' },

      { id: 's2', name: '一閃',   cdMax: 3, hit: 100, type: 'attack', multiplier: 0,   range: 'pierce_all',
        pierce: true,
        effects: [],
        desc: '直線上を杖で貫く。中ダメージ。' },
  ...
  { id: 20, name: 'ミズキ', gender: 'man', rarity: 'sr',
    ...
    skills: [
      ...
      { id: 's5', name: '蛇ノ撃', cdMax: 5, hit: 100, type: 'move',   multiplier: 3.0,   range: 'front3_row_3',
        pierce: false,
        effects: [],
        desc: '直線上の敵に大ダメージ。' },
    ]},
