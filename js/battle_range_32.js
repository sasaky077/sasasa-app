...
(function () {
  ...
  const RANGE_PRESETS_32 = {
    ...
    // ミア s1：キャット・スナイプ。近距離を捨てた前方3〜5マスの狙撃線
    cat_snipe_ally: [
      { dr: -3, dc:  0 },
    ...
    // ミア ULT：ルミニャス・シュート。前方3〜5マスに広がる遠距離制圧範囲
    cat_luminous_far_ally: [
      { dr: -3, dc: -1 }, { dr: -3, dc:  0 }, { dr: -3, dc:  1 },
      { dr: -4, dc: -2 }, { dr: -4, dc: -1 }, { dr: -4, dc:  0 }, { dr: -4, dc:  1 }, { dr: -4, dc:  2 },
      { dr: -5, dc: -1 }, { dr: -5, dc:  0 }, { dr: -5, dc:  1 },
    ],
...
front2_backdiag2: [
  ...
  { dr:  2, dc:  1 }, // 2マス下・右
    ...
    // cat_step：ミア専用。接近戦を避けるための後退・横跳び・斜め逃げステップ
    // 前に詰める力は弱いが、左右と後方へ大きく距離を取り直せる。
    cat_step: [
      { dr:  1, dc: -1 }, { dr:  1, dc:  0 }, { dr:  1, dc:  1 },
      { dr:  2, dc: -1 },                     { dr:  2, dc:  1 },
      { dr:  0, dc: -2 },                     { dr:  0, dc:  2 },
