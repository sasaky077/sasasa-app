...
skills: [
  ...
  { id: 2, name: 'ウルフ', rarity: 'sr',
    ...
    battleImg: 'images/chara_02.webp',
  ...
  // ── id:3 リゼ
  { id: 3, name: 'リゼ', rarity: 'r', hidden: false,
    element: 'wood',
    role: '継続・回復',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    ...
    skills: [
      { id: 's1', name: '通常攻撃', linkCost: 3, isUltimate: false, hit: 100, criticalRate: 0.10, criticalDamageRate: 1.5, type: 'attack', multiplier: 1.5, range: 'front3', effects: [], hitStyle: 'normal', desc: '前方の敵へ攻撃する。' },
      { id: 'ult', name: 'ULT', linkCost: 5, isUltimate: true, hit: 100, criticalRate: 0.10, criticalDamageRate: 1.5, type: 'attack', multiplier: 2.5, range: 'enemy_all', effects: [], hitStyle: 'heavy', desc: 'シューティング側の固有ULT仕様に従う。名称・数値は調整中。' }
    ]
  },

  // ── id:4 ハヤテ
  { id: 4, name: 'ハヤテ', rarity: 'sr',
    element: 'light',
    role: '速度寄り',
    moveType: 'king_8',
    costMax: 14,
  ...
  // ── id:5 ジグ
  { id: 5, name: 'ジグ', rarity: 'r', hidden: false,
    element: 'wood',
    role: 'レーザー',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
...
skills: [
  ...
  // ── id:8 シュリ
  { id: 8, name: 'シュリ', rarity: 'sr', hidden: false, pool: 'survivor',
    element: 'dark',
    role: '高火力・拘束',
    moveType: 'cross_1',
    costMax: 14,
    ...
    battleImg: 'images/chara_08.webp',
    battleUpImg: 'images/chara_08_up.webp',
    ...
    combo: {
      range: 'combo_line_all',
      skill: {
        id: 'combo', name: '緋閃', type: 'attack',
        multiplier: 0.80, range: 'front3', effects: [], hitStyle: 'multi',
        desc: '同列の味方スキルに反応し、前方へ紅黒の追撃を放つ。'
      }
    },
    skills: [
      {
...
skills: [
...

      {
        ...
        range: 'front2',
        summonName: '茨薔薇',
        summonImg: 'images/chara_09_set.webp',
        summonDuration: 2,
        summonDistance: 2,
        summonCount: 3,
        summonOffsets: [
  ...
  // ── id:10 オリオン
  { id: 10, name: 'オリオン', rarity: 'r', hidden: false,
    element: 'light',
    role: '精密・光撃',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
  ...
  // ── id:12 シイナ
  { id: 12, name: 'シイナ', rarity: 'r', hidden: false,
    element: 'dark',
    role: '妨害フィールド',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
  ...
  // ── id:17 アイナ
  { id: 17, name: 'アイナ', rarity: 'r', hidden: false,
    element: 'fire',
    role: 'チャージ・時限',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
  ...
  // ── id:18 シオン
  { id: 18, name: 'シオン', rarity: 'r', hidden: false,
    element: 'dark',
    role: '精密・弱体',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    ...
    battleUpImg: 'images/chara_18_battle_up.webp',
  ...
  // ── id:19 ラグナ
  { id: 19, name: 'ラグナ', rarity: 'r', hidden: false,
    element: 'fire',
    role: '範囲火力',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    ...
    battleUpImg: 'images/chara_19_battle_up.webp',
...
skills: [
  ...
  { id: 21, name: 'アンジェ', rarity: 'r',
    ...
    img: 'images/chara_21.webp', 
    cutImg: 'images/chara_21_cut.webp', 
    ultImg: 'images/chara_21_cutin.webp',
    upImg: 'images/chara_21_up.webp', 
    battleImg: 'images/chara_21_battle.webp',
    battleUpImg: 'images/chara_21_battle_up.webp',
    battleBackImg: 'images/chara_21_battle_back.webp',
    panelImg: 'images/chara_21_panel.webp',
...
,
  ...
  // ── id:22 ベロニカ
  { id: 22, name: 'ベロニカ', rarity: 'r', hidden: false,
    element: 'aqua',
    role: '精密・制圧',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 600, ATK: 250 },
    img: 'images/chara_22.webp',
    cutImg: 'images/chara_22_cut.webp',
    ultImg: 'images/chara_22_cutin.webp',
    upImg: 'images/chara_22_up.webp',
    battleImg: 'images/chara_22_battle.webp',
  ...
  // ── id:23 セレナ
  { id: 23, name: 'セレナ', rarity: 'r', hidden: false,
    element: 'wood',
    role: '召喚・攻撃',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 600, ATK: 250 },
    img: 'images/chara_23.webp',
    cutImg: 'images/chara_23_cut.webp',
    ultImg: 'images/chara_23_cutin.webp',
    upImg: 'images/chara_23_up.webp',
    battleImg: 'images/chara_23_battle.webp',
    battleUpImg: 'images/chara_23_battle_up.webp',
    battleBackImg: 'images/chara_23_battle_back.webp',
    panelImg: 'images/chara_23_panel.webp',
    favScale: 0.88, favOffsetY: -20,
    uiScale: {panel: 1.0,battleBack: 0.72,battleUp: 1.0},
    combo: { range: 'combo_line_all', skill: { id: 'combo', name: '共鳴攻撃', type: 'attack', multiplier: 0.70, range: 'front3', effects: [], hitStyle: 'normal', desc: '同列の味方スキルに反応して追撃する。' } },
    skills: [
  ...
  // ── id:24 ノエル
  { id: 24, name: 'ノエル', rarity: 'r', hidden: false,
    element: 'light',
    role: '支援・アイテム',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 600, ATK: 250 },
    img: 'images/chara_24.webp',
    cutImg: 'images/chara_24_cut.webp',
    ultImg: 'images/chara_24_cutin.webp',
    upImg: 'images/chara_24_up.webp',
    battleImg: 'images/chara_24_battle.webp',
    battleUpImg: 'images/chara_24_battle_up.webp',
    battleBackImg: 'images/chara_24_battle_back.webp',
    panelImg: 'images/chara_24_panel.webp',
    favScale: 0.88, favOffsetY: -20,
    uiScale: {panel: 1.0,battleBack: 0.72,battleUp: 1.0},
    combo: { range: 'combo_line_all', skill: { id: 'combo', name: '共鳴攻撃', type: 'attack', multiplier: 0.70, range: 'front3', effects: [], hitStyle: 'normal', desc: '同列の味方スキルに反応して追撃する。' } },
    skills: [
  ...
  // ── id:25 リュネ
  { id: 25, name: 'リュネ', rarity: 'r', hidden: false,
    element: 'aqua',
    role: 'レーザー',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 600, ATK: 250 },
    img: 'images/chara_25.webp',
    cutImg: 'images/chara_25_cut.webp',
    ultImg: 'images/chara_25_cutin.webp',
    upImg: 'images/chara_25_up.webp',
    battleImg: 'images/chara_25_battle.webp',
    battleUpImg: 'images/chara_25_battle_up.webp',
    battleBackImg: 'images/chara_25_battle_back.webp',
    panelImg: 'images/chara_25_panel.webp',
    favScale: 0.88, favOffsetY: -20,
    uiScale: {panel: 1.0,battleBack: 0.72,battleUp: 1.0},
    combo: { range: 'combo_line_all', skill: { id: 'combo', name: '共鳴攻撃', type: 'attack', multiplier: 0.70, range: 'front3', effects: [], hitStyle: 'normal', desc: '同列の味方スキルに反応して追撃する。' } },
    skills: [
  ...
  moveType: 'front_back_row3',
    ...
    img: 'images/chara_26.webp', 
    cutImg: 'images/chara_26_cut.webp', 
    ultImg: 'images/chara_26_cutin.webp',
    upImg: 'images/chara_26_up.webp', 
    battleImg: 'images/chara_26_battle.webp',
    battleUpImg: 'images/chara_26_battle_up.webp',
    battleBackImg: 'images/chara_26_battle_back.webp',
    panelImg: 'images/chara_26_panel.webp',
 ...
 element: 'dark',
    ...
    img: 'images/chara_27.webp', 
    cutImg: 'images/chara_27_cut.webp', 
    ultImg: 'images/chara_27_cutin.webp',
    upImg: 'images/chara_27_up.webp', 
    battleUpImg: 'images/chara_27_battle_up.webp',
    battleImg: 'images/chara_27_battle.webp',
    battleBackImg: 'images/chara_27_battle_back.webp',
    panelImg: 'images/chara_27_panel.webp',
...
{ id: 'ult',
  ...
  { id: 28, name: 'ミモザ', rarity: 'sr',
    ...
    img: 'images/chara_28.webp', 
    cutImg: 'images/chara_28_cut.webp', 
    ultImg: 'images/chara_28_cutin.webp',
    upImg: 'images/chara_28_up.webp', 
    battleImg: 'images/chara_28_battle.webp',
    battleUpImg: 'images/chara_28_battle_up.webp',
    battleBackImg: 'images/chara_28_battle_back.webp',
    panelImg: 'images/chara_28_panel.webp',
    favScale: 0.85, favOffsetY: -45,
  ...
  moveType: 'vertical2_frontdiag2',
    ...
    img: 'images/chara_29.webp', 
    cutImg: 'images/chara_29_cut.webp', 
    ultImg: 'images/chara_29_cutin.webp',
    upImg: 'images/chara_29_up.webp', 
    battleImg: 'images/chara_29_battle.webp',
    battleUpImg: 'images/chara_29_battle_up.webp',
    battleBackImg: 'images/chara_29_battle_back.webp',
    panelImg: 'images/chara_29_panel.webp',
    favScale: 0.85, favOffsetY: -50,
    ...
    skills: [
{
  ...
  // ── id:30 リズ
  { id: 30, name: 'リズ', rarity: 'r', hidden: false,
    element: 'aqua',
    role: '追尾・召喚',
    moveType: 'cross_1',
    costMax: 10, costStart: 5, costRegen: 3,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 600, ATK: 250 },
    img: 'images/chara_30.webp',
    cutImg: 'images/chara_30_cut.webp',
    ultImg: 'images/chara_30_cutin.webp',
    upImg: 'images/chara_30_up.webp',
    battleImg: 'images/chara_30_battle.webp',
    battleUpImg: 'images/chara_30_battle_up.webp',
    battleBackImg: 'images/chara_30_battle_back.webp',
    panelImg: 'images/chara_30_panel.webp',
    favScale: 0.88, favOffsetY: -20,
    uiScale: {panel: 1.0,battleBack: 0.72,battleUp: 1.0},
    combo: { range: 'combo_line_all', skill: { id: 'combo', name: '共鳴攻撃', type: 'attack', multiplier: 0.70, range: 'front3', effects: [], hitStyle: 'normal', desc: '同列の味方スキルに反応して追撃する。' } },
    skills: [
  ...
  moveType: 'line_front_3',
    ...
    shinkiRegen: 1,
    stats: { HP: 600, ATK: 250 },
    img: 'images/chara_31.webp', 
    cutImg: 'images/chara_31_cut.webp', 
    ultImg: 'images/chara_31_cutin.webp',
    upImg: 'images/chara_31_up.webp', 
    battleImg: 'images/chara_31_battle.webp',
    battleUpImg: 'images/chara_31_battle_up.webp',
    battleBackImg: 'images/chara_31_battle_back.webp',
    panelImg: 'images/chara_31_panel.webp',
...
skills: [
  ...
  // ── id:32 イヴェルナ（限定SR / FIRE / LASER）
  { id: 32, name: 'イヴェルナ', rarity: 'sr',
    element: 'fire',
    role: '高密度レーザー',
    moveType: 'cross_1',
    costMax: 14, costStart: 5, costRegen: 3,
    shinkiMax: 5, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 620, ATK: 300 },
    img: 'images/chara_32.webp',
    cutImg: 'images/chara_32_cut.webp',
    ultImg: 'images/chara_32_cutin.webp',
    upImg: 'images/chara_32_up.webp',
    battleImg: 'images/chara_32_battle.webp',
    battleUpImg: 'images/chara_32_battle_up.webp',
    battleBackImg: 'images/chara_32_battle_back.webp',
    panelImg: 'images/chara_32_panel.webp',
    favScale: 0.88, favOffsetY: -30,
    uiScale: {panel: 1.0,battleBack: 1.0,battleUp: 1.0},
    combo: { range: 'combo_line_all', skill: { id: 'combo', name: '紅の残光', type: 'attack', multiplier: 0.80, range: 'front3', effects: [], hitStyle: 'multi', desc: '同列の味方スキルに反応し、前方へ高密度の紅光を放つ。' } },
    skills: [
      { id: 's1', name: '紅光照射', linkCost: 3, isUltimate: false, hit: 100, criticalRate: 0.10, criticalDamageRate: 1.5, type: 'attack', multiplier: 1.7, range: 'front3', effects: [], hitStyle: 'multi', desc: '前方へ高密度の火属性光線を照射する。' },
      { id: 'ult', name: '終端紅閃', linkCost: 5, isUltimate: true, hit: 100, criticalRate: 0.10, criticalDamageRate: 1.5, type: 'attack', multiplier: 4.0, range: 'front_all', effects: [], hitStyle: 'heavy', desc: '前方を貫く大出力の紅色光線を放つ。' }
    ]
  },

  // ── id:33 レイ（恒常SR / AQUA）
  { id: 33, name: 'レイ', rarity: 'sr',
    element: 'aqua',
    role: 'バランス寄り',
    moveType: 'line_front_3',
    costMax: 12, costStart: 5, costRegen: 4,
    shinkiMax: 4, shinkiStart: 0, shinkiRegen: 1,
    stats: { HP: 650, ATK: 255 },
    img: 'images/chara_33.webp',
    cutImg: 'images/chara_33_cut.webp',
    ultImg: 'images/chara_33_cutin.webp',
    upImg: 'images/chara_33_up.webp',
    battleImg: 'images/chara_33_battle.webp',
    battleUpImg: 'images/chara_33_battle_up.webp',
    battleBackImg: 'images/chara_33_battle_back.webp',
    panelImg: 'images/chara_33_panel.webp',
    favScale: 0.90, favOffsetY: -25,
    uiScale: {panel: 1.0,battleBack: 1.0,battleUp: 1.0},
    combo: { range: 'combo_cross_1', skill: { id: 'combo', name: '水脈の余波', type: 'attack', multiplier: 0.65, range: 'around8', effects: [], hitStyle: 'normal', desc: '隣接する味方スキルに反応し、水流の追撃を行う。' } },
    skills: [
      { id: 's1', name: '水穿', linkCost: 3, isUltimate: false, hit: 100, criticalRate: 0.10, criticalDamageRate: 1.5, type: 'attack', multiplier: 1.6, range: 'front3', effects: [], hitStyle: 'normal', desc: '凝縮した水流を前方へ放つ。' },
      { id: 'ult', name: '蒼流界', linkCost: 5, isUltimate: true, hit: 100, criticalRate: 0.10, criticalDamageRate: 1.5, type: 'attack', multiplier: 3.6, range: 'enemy_all', effects: [], hitStyle: 'multi', desc: '広範囲へ水流を展開し、敵全体を攻撃する。' }
    ]
  },
