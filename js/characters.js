...
const CHARACTERS = [
  ...
  { id: 7, name: 'ミユ', gender: 'woman', rarity: 'r',
    ...
    skills: [
      { id: 's1', name: '糸斬',   cdMax: 0, hit: 90,  type: 'attack', multiplier: 1.0, range: 'front1',
        effects: [],
        desc: '細い糸で怪異を切り裂く。素早い攻撃。' },

      { id: 's2', name: '操糸',   cdMax: 3, hit: 100, type: 'debuff', multiplier: 0,   range: 'col_center',
        effects: [{ type: 'spd_down', target: 'enemy', hit: 80, duration: 2 }],
        desc: '糸で怪異を縛りSPDを2ターン低下させる。' },

      { id: 's3', name: '糸実体', cdMax: 3, hit: 85,  type: 'debuff', multiplier: 0,   range: 'front1',
  ...
  { id: 8, name: 'カミジョウ', gender: 'man', rarity: 'r',
    ...
    skills: [
      { id: 's1', name: '守護撃',  cdMax: 0, hit: 100, type: 'attack', multiplier: 1.0, range: 'front1',
        effects: [],
        desc: '守りながら攻撃する。確実に命中する。' },

      { id: 's2', name: '繋ぎ手',  cdMax: 3, hit: 100, type: 'debuff', multiplier: 0,   range: 'front1',
        effects: [{ type: 'jittai', target: 'enemy', hit: 100, duration: 2 }],
      ...
      { id: 's4', name: '重撃',    cdMax: 3, hit: 80,  type: 'attack', multiplier: 2.0, range: 'front1',
  ...
  { id: 10, name: 'フミカ', gender: 'woman', rarity: 'sr',
    ...
    skills: [
      { id: 's1', name: '閃撃',   cdMax: 0, hit: 90,  type: 'attack', multiplier: 1.5, range: 'front1',
        effects: [],
        desc: '光速の一撃を放つ。ATKの1.5倍のダメージ。' },

      { id: 's2', name: '速縛',   cdMax: 3, hit: 100, type: 'debuff', multiplier: 0,   range: 'col_center',
        effects: [
          { type: 'spd_down', target: 'enemy', hit: 85, duration: 2 },
          { type: 'atk_down', target: 'enemy', hit: 75, duration: 2 },
        ],
        desc: '素早い動きで怪異のSPDとATKを2ターン低下させる。' },

      { id: 's3', name: '速実',   cdMax: 3, hit: 90,  type: 'debuff', multiplier: 0,   range: 'front1',
  ...
  { id: 15, name: 'アキ', gender: 'woman', rarity: 'sr',
    ...
    favScale: 0.85, favOffsetY: -30,
    skills: [
      { id: 's1', name: '祓斬',  cdMax: 0, hit: 85,  type: 'attack', multiplier: 1.5, range: 'front1',
        effects: [],
        desc: '祓いの力を込めた斬撃。ATKの1.5倍のダメージ。' },

      { id: 's2', name: '繋縛',  cdMax: 4, hit: 100, type: 'debuff', multiplier: 0,   range: 'front1',
        effects: [
      ...
      { id: 's3', name: '加護',  cdMax: 4, hit: 100, type: 'buff',   multiplier: 0,   range: 'all',
        ...
        desc: '仲間全員のDEFを2ターン上昇させ、次のターン全員必中にする。' },

      { id: 's4', name: '疾撃',  cdMax: 2, hit: 90,  type: 'attack', multiplier: 2.0, range: 'front1',
        effects: [],
  ...
  { id: 19, name: 'アンナ', gender: 'woman', rarity: 'sr',
    ...
    skills: [
      { id: 's1', name: '狼牙撃', cdMax: 0, hit: 100, type: 'attack', multiplier: 1.0, range: 'front1',
        effects: [],
        desc: '狼の力を宿した確実な一撃。' },
      ...
      { id: 's4', name: '繋ぎ鎖', cdMax: 3, hit: 95,  type: 'attack', multiplier: 1.5, range: 'front1',
        effects: [{ type: 'jittai', target: 'enemy', hit: 90, duration: 2 }],
  ...
  // ── id:20 ミズキ（速度寄り）──────────────────────────────────
  // 縦列貫通と強制移動でポジションを支配する。吸い寄せで敵を引き出す。
  { id: 20, name: 'ミズキ', gender: 'man', rarity: 'sr',
    ...
    skills: [
      { id: 's1', name: '蛇牙',   cdMax: 0, hit: 90,  type: 'attack', multiplier: 1.5, range: 'front1',
        effects: [],
        desc: '蛇のように素早い一撃。ATKの1.5倍のダメージ。' },

      { id: 's2', name: '蛇縛',   cdMax: 3, hit: 100, type: 'debuff', multiplier: 0,   range: 'col_center',
        effects: [
          { type: 'spd_down', target: 'enemy', hit: 80, duration: 2 },
          { type: 'pull_1',   target: 'enemy', hit: 80, duration: 1 },
        ],
        desc: '蛇の力でSPDを下げながら怪異を1マス吸い寄せる。' },

      { id: 's3', name: '蛇実',   cdMax: 3, hit: 85,  type: 'debuff', multiplier: 0,   range: 'front1',
        effects: [
          { type: 'jittai',  target: 'enemy', hit: 85, duration: 2 },
          { type: 'pull_2',  target: 'enemy', hit: 70, duration: 1 },
        ],
        desc: '怪異を実体化させながら2マス吸い寄せる。' },

      { id: 's4', name: '毒牙',   cdMax: 4, hit: 65,  type: 'attack', multiplier: 5.0, range: 'pierce3',
  ...
  { id: 14, name: 'アイム', gender: 'man', rarity: 'ur',
    ...
    skills: [
      ...
      { id: 's2', name: '虚像劇', cdMax: 3, hit: 100, type: 'debuff', multiplier: 1.0,   range: 'all',
        effects: [
          { type: 'jittai',   target: 'enemy', hit: 100, duration: 1 },
